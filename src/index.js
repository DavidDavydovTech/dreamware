...
app.loader
  ...
  // --Clingy Games--
    ...
    .add('pingHitEffectB', 'img/clingy/pingpong/hit_00001.png')
    ...
    .add('iceBgA', 'img/clingy/iceskate/ice_0000.png')
    ...
    .add('icePlayer', 'img/clingy/iceskate/you_0000.png')
    .add('icePlayer', 'img/clingy/iceskate/you_0001.png')
    // Snow Sledding
    .add('iceBgA', 'img/clingy/snowsled/bg_0000.png')
    .add('iceIconsA', 'img/clingy/snowsled/icons_0000.png')
    .add('iceIconsB', 'img/clingy/snowsled/icons_0001.png')
    .add('iceBarA', 'img/clingy/snowsled/bar_0000.png')
    .add('iceBarB', 'img/clingy/snowsled/bar_0001.png')
    .add('iceRampA', 'img/clingy/snowsled/ramp_0000.png')
    .add('iceRockA', 'img/clingy/snowsled/rock_0000.png')
    .add('icePengA', 'img/clingy/snowsled/peng_0000.png')
    .add('icePengB', 'img/clingy/snowsled/peng_0001.png')
    .add('iceWinA', 'img/clingy/snowsled/win_0000.png')
    .add('iceWinB', 'img/clingy/snowsled/win_0001.png')
    .add('iceLossA', 'img/clingy/snowsled/loss_0000.png')
    .add('iceLossB', 'img/clingy/snowsled/loss_0001.png')
    // Typing
    ...
    .add('typeHillA', 'img/clingy/typing/cursor_0000.png')
    .add('typeHillB', 'img/clingy/typing/cursor_0001.png')
    .add('typeQuestionA', 'img/clingy/typing/cursor_0000.png')
    .add('typeQuestionB', 'img/clingy/typing/cursor_0001.png')
    ...
    .add('hdBubbleA', 'img/clingy/hotdog/bacon_0000.png')
    .add('hdBubbleB', 'img/clingy/hotdog/bacon_0001.png')
  ...
  // --Impy Games--
    ...
    .add('flashDoorCloseD', 'img/impy/flashlight/door_open_0003.png')
    ...
    .add('flashImpyDark2A', 'img/impy/flashlight/impydark_0000.png')
    .add('flashImpyDark2B', 'img/impy/flashlight/impydark_0001.png')
    ...
    .add('flashMonsterC', 'img/impy/flashlight/monster_0000.png')
    .add('flashMonsterD', 'img/impy/flashlight/monster_0001.png')
    .add('flashMonsterE', 'img/impy/flashlight/monster_0000.png')
    ...
    .add('sketchPaperB', 'img/impy/sketchman/paper_0000.png')
  ...
  // --Miro Games--
    ...
    .add('flowerBasketsB', 'img/miro/flowers/baskets_0001.png')
