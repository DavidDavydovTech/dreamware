...
app.loader
  ...
  // -- Assets needed for the HUD --
    ...
    // HUD Meter
    .add('barA', 'img/hud/bar.png')
    .add('barB', 'img/hud/bar1.png')
    .add('barHeartA', 'img/hud/bar.png')
    .add('barHeartB', 'img/hud/bar1.png')
    .add('barLineA', 'img/hud/line.png')
    .add('barLineB', 'img/hud/line1.png')
  ...
  // --Miro Games--
    ...
    .add('sfxPianoClick', 'sfx/Clickaclick.mp3')
    .add('sfxDoorClose', 'sfx/Door_Close.mp3')
    .add('sfxFlashlightClick', 'sfx/Flashlight.mp3')
    .add('sfxFlashlightOn', 'sfx/electricity.mp3')
    .add('sfxWoodBlock', 'sfx/wood_block.mp3')
    .add('sfxUgh', 'sfx/UGH.mp3')
    .add('sfxGhostGun', 'sfx/Ghost_Gun.mp3')
    .add('sfxBongoLow', 'sfx/bongo_low.mp3')
    .add('sfxBongoMed', 'sfx/bongo_med.mp3')
