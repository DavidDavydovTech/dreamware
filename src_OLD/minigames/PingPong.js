...
export const GetPingPongFuncs = () => {
    ...
    function update() {
        ...
        // Player collision
        if (
            sprites.pingBall.x < sprites.pingPaddle.x + sprites.pingPaddle.width &&
        ...
        // Enemy collision
        if (
            sprites.pingBall.x < sprites.pingEnPaddle.x + sprites.pingEnPaddle.width &&
