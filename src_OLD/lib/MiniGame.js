...
class MiniGame extends Container {
    ...
    constructor({
        ...
        this._minigameComplete = Promise.all([this.didTimeout, this.didWin]);

        this.mask = new Graphics().beginFill(0xffffff).drawRect(0, 0, 800, 800).endFill();
    ...
    failMG = () => {
        console.error("The failMG method WAS NOT UPDATED; MINIGAME CAN NOT BE FAILED!");
    };
    winMG = () => {
        console.error("The winMG method WAS NOT UPDATED; MINIGAME CAN NOT BE WON!");
    };
